  ...
  Widget build(BuildContext context) => Column(
        children: [
          Text.rich(
            ...
            style: TextStyle(fontSize: 47 * scale, fontWeight: FontWeight.w800, height: 1, color: Colors.white),
          ),
          SizedBox(height: 8 * scale),
          Text('GROUP CHATS. PRIVACY FIRST.', style: TextStyle(fontSize: 9 * scale, letterSpacing: 1.1, color: const Color(0xFFB7B2C1))),
        ...
        child: Column(
          ...
          children: [
            Text.rich(
              ...
              style: TextStyle(fontSize: 24 * scale, fontWeight: FontWeight.w700, color: Colors.white),
            ),
            ...
            Text(
              ...
              style: TextStyle(fontSize: 13 * scale, height: 1.28, color: const Color(0xFFB7B2C1)),
            ),
            ...
            Row(children: [
              const Expanded(child: Divider(color: Color(0xFF41465A))),
              Padding(padding: EdgeInsets.symmetric(horizontal: 17 * scale), child: Text('OR', style: TextStyle(color: const Color(0xFFB7B2C1), fontSize: 13 * scale))),
              const Expanded(child: Divider(color: Color(0xFF41465A))),
            ]),
            ...
            SizedBox(
              ...
              child: OutlinedButton.icon(
                onPressed: () => context.go('/invite-code'),
            ...
            GestureDetector(
              ...
              child: Text.rich(
                ...
                style: TextStyle(fontSize: 13 * scale, color: const Color(0xFFB7B2C1)),
              ),
            ),
          ],
        ),
